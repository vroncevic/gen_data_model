...
python3 main.py create --name "pydantic_model" --type pydantic --output "./demo"
python3 main.py create --name "dataclass_model" --type dataclass --output "./demo"
python3 main.py create --name "sqlmodel_model" --type sqlmodel --output "./demo"
